                ...
                <Box sx={{
                    ...
                    <Box sx={{
                        ...
                        <Box sx={{
                            ...
                            onClick={() => navigate('/ownerUploadDocuments')}>
                    ...
                    <Box sx={{
                        ...
                        {statusList.map((status, index) => (
                            <NavTab key={index} color={statusColor[index]} onClick={() => handleTabClick(index)}>
                                {status}
                            </NavTab>
                        ))}
                    </Box>
                    <Box sx={{
                        ...
                        <Box sx={{
                            ...
                            {documentsData[statusList[tabStatus]]?.map((document, index) => {
                                ...
                                return (
                                    <DocumentCard key={index} document={document.contract_documents || []} data={[address, unit, start_date, end_date]} />
                                );
                            })}
                        </Box>
                    </Box>
...
function DocumentCard(props) {
    ...
    const navigateToDocument = (url, link) => {
        navigate(url, {
            state: {
                link: link,
            }
