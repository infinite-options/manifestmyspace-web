                            ...
                            <Box sx={{
                                ...
                                switch (statusList[tabStatus]) {
                                    ...
                                    case 'Contracts':
                                        ...
                                        if (document.contract_documents !== null && document.lease_documents === null) {
                                ...
                                {/* {contractsData.map((document) => {                                    
                                    ...
                                    const zip = document.property_zip;
                                    const state = document.property_state;
                                    const owner_name = document.owner_first_name + " " + document.owner_last_name;
                                    const owner_contact = document.owner_phone_number;
                                    const owner_email = document.owner_email;
                                    let start_date = '';
                                    let end_date = '';
                                    let docs = [];
                                    switch (statusList[tabStatus]) {                                        
                                    ...
                                    return (
                                        <>
                                            {docs.map((doc) => (
                                                <DocumentCard document={doc} data={[address, unit, city, zip, state, start_date, end_date, owner_name, owner_contact, owner_email]} tab="Contracts"/>
                                            ))}
                                        </>
                                    )
                                })} */}
                                ...
                                {/* {leasesData.map((document) => {                                    
                                    ...
                                    return (
                                        <>
                                            {docs.map((doc) => (
                                                <DocumentCard document={doc} data={[address, unit, city, state, zip, start_date, end_date]} tab="Leases"/>
                                            ))}
                                        </>
                                    )
                                })} */}
    ...
    return (
        <Box sx={{
            ...
            {/* <Box sx={{
                ...
                <Box>
                    Created: {start_date? start_date : "<START_DATE>"}
                </Box>
                <Box>
                    By: {"<Doolittle Managements>"}
                </Box>
                <Box>
                    Expires: {end_date? end_date : "<END_DATE>"}
                </Box>
                <Box>
                    For: {"<Kim Gordon>"}
                </Box>
