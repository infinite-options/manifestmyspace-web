          ...
          >
            ...
            >
              ...
              >
                ...
                <Box>
                  ...
                  >
                    {index + 1} Of {passedData.length} {contactsTab}
                  </Typography>
                </Box>
                <Box>
                  <svg width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <Stack flexDirection="row" justifyContent="space-between" sx={{ padding: "0 15px" }}>
              <Stack>
                ...
                <Stack flexDirection="row">
                  ...
                  >
                    {formattedPhoneNumber(selectedData.contact_phone_numnber)}
                  </Typography>
                </Stack>
              </Stack>
              {contactsTab === "Owner" ? (
                <Stack sx={{ paddingLeft: "10px" }} alignItems="flex-end">
                  <Typography
                    sx={{
                      fontWeight: theme.typography.primary.fontWeight,
                      fontSize: "13px",
            ...
            <Stack flexDirection="row" sx={{ padding: "0 15px" }}>
              ...
              <Typography sx={{ fontSize: "13px" }}>
                ...
                {", "}
                {selectedData.contact_state} {selectedData.contact_zip}
              </Typography>
            </Stack>
              ...
              <Stack flexDirection="row">
                ...
                <Stack justifyContent="space-between" alignItems="center" sx={{ paddingLeft: "15px" }}>
                  {owner_object.owner_ein_number === "" ? (
                    ...
                    >
                      {maskEIN(owner_object.owner_ein_number)}
                    </Typography>
                  )}
                  <Typography
                    sx={{
