  ...
  return (
    <Grid container sx={{ backgroundColor: theme.palette.primary.main, borderRadius: "10px", padding: "10px" }}>
      <Grid item xs={12} container justifyContent='center' sx={{ height: "50px" }}>
        <Typography sx={{ fontSize: "35px", fontWeight: "bold", color: "#160449" }}>Manager Contact</Typography>
      </Grid>
      ...
      <Grid
        ...
        sx={{ backgroundColor: "#3D5CAC", borderRadius: "10px", marginBottom: "10px", paddingTop: "5px", paddingBottom: "10px", minHeight: "120.5px" }}
      >
        <Grid item xs={1}>
          <Box
            onClick={() => {
      ...
      <Grid container item xs={12} columnSpacing={1} rowSpacing={1} sx={{}}>
        <Grid item xs={6}>
          ...
          >
            <Grid item xs={12}>
              <Typography sx={{ fontSize: "20px", fontWeight: "bold", color: "#160449" }}>CONTACT INFORMATION</Typography>
            </Grid>
        ...
        <Grid item xs={6}>
          ...
          >
            <Grid item xs={12}>
              <Typography sx={{ fontSize: "20px", fontWeight: "bold", color: "#160449" }}>AVAILABLE HOURS</Typography>
            </Grid>
          </Paper>
        </Grid>
        <Grid item xs={12} md={6}>
          ...
          >
            ...
            <Grid container direction='row' item xs={12} alignContent='center' sx={{ marginTop: "10px" }}>
              <Typography sx={{ color: "#160449", fontWeight: "600" }}>Website:</Typography>
            </Grid>
            <Grid container direction='row' item xs={12} alignContent='center' sx={{ marginTop: "10px" }}>
              <Typography sx={{ color: "#160449", fontWeight: "600" }}>Email Address:</Typography>
            </Grid>
            <Grid container direction='row' item xs={12} alignContent='center' sx={{ marginTop: "10px" }}>
              <Typography sx={{ color: "#160449", fontWeight: "600" }}>Phone #:</Typography>
            </Grid>
            <Grid container direction='row' item xs={12} alignContent='center' sx={{ marginTop: "10px" }}>
              <Typography sx={{ color: "#160449", fontWeight: "600" }}>Address:</Typography>
            </Grid>
            <Grid container direction='row' item xs={12} alignContent='center' sx={{ marginTop: "10px" }}>
              <Typography sx={{ color: "#160449", fontWeight: "600" }}>Open Office Hours:</Typography>
            </Grid>
            <Grid container direction='row' item xs={12} alignContent='center' sx={{ marginTop: "10px" }}>
              <Typography sx={{ color: "#160449", fontWeight: "600" }}>Clsoed Office Hours:</Typography>
            </Grid>
          </Paper>
        </Grid>
        <Grid item xs={12} md={6}>
...
const MaintenanceContactDetail = ({ data, currentIndex, setCurrentIndex }) => {
  ...
  return (
    <Grid container sx={{ backgroundColor: theme.palette.primary.main, borderRadius: "10px", padding: "10px" }}>
      <Grid item xs={12} container justifyContent='center' sx={{ height: "50px" }}>
        <Typography sx={{ fontSize: "35px", fontWeight: "bold", color: "#160449" }}>Maintenance Contact</Typography>
      </Grid>
      <Grid item xs={12} container justifyContent='center'>
        <Typography sx={{ fontSize: "20px", color: "#3D5CAC" }}>
      ...
      <Grid
        ...
        direction='row'
        alignContent='space-between'
        sx={{ backgroundColor: "#A52A2A", borderRadius: "10px", marginBottom: "10px", paddingTop: "5px", paddingBottom: "10px", minHeight: "120.5px" }}
      >
        <Grid item xs={1}>
          <Box
            onClick={() => {
        ...
        <Grid container item xs={12} columnSpacing={1}>
          <Grid item xs={12} md={6}>
            ...
            >
              ...
              <Grid item xs={12}>
                <Typography sx={{ color: "#160449" }}>
                  {`${contactDetails && contactDetails[currentIndex]?.business_address ? contactDetails[currentIndex]?.business_address : ""}, ${
                    contactDetails && contactDetails[currentIndex]?.business_city ? contactDetails[currentIndex]?.business_city : ""
                  }`}
                </Typography>
              </Grid>
              <Grid container direction='row' item xs={12} alignContent='center' sx={{ marginTop: "10px" }}>
              ...
              <Typography sx={{ color: "#160449", fontWeight: "bold" }}>
                {contactDetails && contactDetails[currentIndex]?.business_services_fees ? (
                  <>
                    Category:{" "}
                    <Typography component='span' sx={{ fontSize: "20px", color: "#160449" }}>
                      {JSON.parse(contactDetails[currentIndex]?.business_services_fees)
                        .map((fee) => fee.service_name)
                        .join(", ")}
                    </Typography>
                  </>
                ) : (
              ...
              <Typography sx={{ color: "#160449", fontWeight: "bold" }}>
                {contactDetails && contactDetails[currentIndex]?.business_locations ? (
                  <>
                    Service Locations:{" "}
                    <Typography component='span' sx={{ color: "#160449" }}>
                      {JSON.parse(contactDetails[currentIndex]?.business_locations)
                        .map((location) => `${location.location} (+-${location.distance} miles)`)
                        .join(", ")}
                    </Typography>
                  </>
                ) : (
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <Typography sx={{ fontSize: "20px", color: "#160449", fontWeight: "bold", textTransform: "uppercase" }}>Previous Jobs</Typography>
            </Paper>
          </Grid>
        </Grid>
      </Grid>
