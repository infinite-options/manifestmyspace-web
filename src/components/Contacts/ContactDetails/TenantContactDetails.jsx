      ...
      >
        ...
        >
          ...
          >
            ...
            <Stack flexDirection="row" sx={{ padding: "15px 15px 0" }}>
              ...
              <Typography sx={{ fontSize: "13px" }}>
                {contactDetails[index].contact_address ? contactDetails[index].contact_address : "<ADDRESS3>"}
            ...
            <Stack sx={{ padding: "15px" }}>
              ...
              >
                <Stack justifyContent="space-between" alignItems="center" sx={{ paddingLeft: "10px" }}>
