            ...
            <Stack flexDirection="row" justifyContent="space-between" sx={{ padding: "0 15px" }}>
              <Stack>
                ...
                {selectedRole === "MAINTENANCE" && (
                  <Stack>
                    <Typography sx={{ fontSize: "13px", fontWeight: theme.typography.primary.fontWeight }}>{`Type: Property Manager`}</Typography>
                    <Typography sx={{ fontSize: "13px", fontWeight: theme.typography.primary.fontWeight }}>{`Notes:`}</Typography>
                  </Stack>
                )}
              </Stack>
            </Stack>
            <Stack flexDirection="row" justifyContent="space-between" sx={{ padding: "10px 15px" }}>
              {selectedRole === "MAINTENANCE" && (
                <Stack>
                  <Typography sx={{ fontSize: "16px", fontWeight: theme.typography.primary.fontWeight }}>{`Previous Jobs`}</Typography>
                </Stack>
              )}
            </Stack>
            {selectedRole === "OWNER" && (
