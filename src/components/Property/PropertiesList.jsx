...
export default function PropertiesList(props) {
  console.log("In Property List - Property List: ", props.propertyList);
  console.log("In Property List - PM Requests: ", props.pmRequests);
  console.log("In Property List - Contracts: ", props.contracts);
  console.log("In Property List - LHS Selection: ", props.LHS);
  ...
  useEffect(() => {
    ...
    setIsDataReady(true);
    if (props.LHS === "List") {
      console.log("LHS selected as List");
      setLHS(props.LHS);
      setDisplayedItems(props.propertyList);
    } else if (props.LHS === "Rent") {
      console.log("LHS selected as RENT");
      setLHS(props.LHS);
      onPropertyInRentWidgetClicked(initialPropInRent);
    } else {
      console.log("LHS selected as PM Request");
      setDisplayedItems(props.pmRequest);
      setLHS("List");
      console.log("LHS reset to List ", LHS);
    }
  }, [props.LHS, props.allRentStatus, props.index, props.propertyList]);

  console.log("Display Items in displayList: ", displayedItems);
  console.log("LHS in Property List: ", LHS);
      ...
      >
        ...
        >
          ...
          <Box sx={{ padding: "10px" }}>
            ...
            {/* If LHS is Rent show the PM Rent Page */}
