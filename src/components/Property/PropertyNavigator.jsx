...
export default function PropertyNavigator({ index, propertyList, allRentStatus, rawPropertyData, contracts, isDesktop = true, props }) {
  ...
  console.log("In Property Navigator: ", getProfileId(), selectedRole);
  ...
  //       console.log("In Property Navigator, Current Role: ", getProfileId());

  //       if (getProfileId().startsWith("110")) {
  //         console.log("The first 3 digits are 110");
  //         const data = response.data["owner_contacts"];
  //         console.log("Contacts Endpoint Data: ", data);
  //         const ownerContacts = data ? data["managers"] : "Refer Manager";
  //         setContactDetails(ownerContacts);
  //       } else if (getProfileId().startsWith("600")) {
  //         console.log("The first 3 digits are 600");
  //         const data = response.data["management_contacts"];
  //         console.log("Contacts Endpoint Data: ", data);
  //         const ownerContacts = data ? data["owners"] : "Refer Owner";
  //         setContactDetails(ownerContacts);
  //       } else {
  //         console.log("The first 3 digits are not 110 or 600");
  //       }
  //     } catch (error) {
