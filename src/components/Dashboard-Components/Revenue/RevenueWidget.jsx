        ...
        <>            
            <Grid container sx={{backgroundColor:'#f0f0f0', borderRadius: '10px',}}>
                <Grid container item xs={12} md={9} sx={{padding: '20px', }}>                                                    
                        <Grid item xs={12} sx={{width: '100%', backgroundColor: '#160449', color: '#FFFFFF', fontWeight: 'bold', marginBottom: '10px', borderRadius: '5px', padding: '5px',  display: 'flex', flexDirection: "row", justifyContent: 'space-between', }}> 
                        ...
                        <Grid item xs={12} sx={{width: '100%', backgroundColor: '#9EAED6', marginBottom: '10px',  borderRadius: '5px', padding: '5px', display: 'flex', flexDirection: "row", justifyContent: 'space-between', }}> 
                        ...
                        <Grid item xs={12} sx={{width: '100%',backgroundColor: '#979797', borderRadius: '5px', padding: '5px',  display: 'flex', flexDirection: "row", justifyContent: 'space-between', }}>
