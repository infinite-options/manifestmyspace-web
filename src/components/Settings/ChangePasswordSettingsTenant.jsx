...
export default function ChangePasswordSettingsTenant(props) {
    const classes = useStyles();
    const navigate = useNavigate();
    const { user } = useUser();
    // console.log("USER - ", user);
    const location = useLocation();
    let tenant_data = props.tenant_data;
    ...
    const handleSubmit = (event) => {
        ...
        if(isEdited){
            ...
            if(emailAddress === ""){
                ...
                axios.put('https://l0h6a9zi1e.execute-api.us-west-1.amazonaws.com/dev/password', modifiedData, headers)
                .then((response) => {
          ...
          >
            ...
            >
                ...
                >
                    ...
                    <TextField name="current_password" value={currentPassword} onChange={handleInputChange} variant="filled" fullWidth placeholder="Old Password" type='password' className={classes.root}></TextField>
                    </Stack>
                    <hr/>

                    <Stack spacing={-2} m={5}>
                    <Typography sx={{ color: theme.typography.common.blue, fontWeight: theme.typography.primary.fontWeight }}>New Password</Typography>
                    <TextField name="new_password" value={newPassword} onChange={handleInputChange} variant="filled" fullWidth placeholder="New Password" type='password' className={classes.root}></TextField>
                    </Stack>
                    ...
                    <TextField name="confirm_new_password" value={confirmNewPassword} onChange={handleInputChange} variant="filled" fullWidth placeholder="Confirm Password" type='password' className={classes.root}></TextField>
                    </Stack>
                    <hr/>
                    ...
                    <TextField name="email_address" value={emailAddress} onChange={handleInputChange} variant="filled" fullWidth placeholder="Enter email address" className={classes.root}></TextField>
