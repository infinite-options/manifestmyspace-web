...
export default function SelectPayment(props) {
  ...
  const payment_url={"Credit Card":'https://huo8rhh76i.execute-api.us-west-1.amazonaws.com/dev/api/v2/createPaymentIntent', 
...
// }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(payment_url[selectedMethod], { // Use http instead of https
        method: 'POST',
        headers,
...
<Stack direction="row" justifyContent="center">
    ...
    <Typography variant="body1">Selected value: {selectedMethod}  {payment_url[selectedMethod]}</Typography>
