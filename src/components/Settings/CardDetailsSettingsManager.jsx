        ...
        >
          ...
          >
            ...
            <Box component="form" onSubmit={handleSubmit} noValidate autoComplete="off" id="editProfileForm">
                  ...
                  <Grid item xs={6}>
                    <Grid container alignItems="center" rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                      <Grid item xs={4}>
                        <Checkbox
                          name="paypal_status"
                          checked={paypalActiveStatus}
                          disabled={!paypal}
                          onChange={(e) => handleStatusChange(e, "paypal")}
              ...
              {showApplePay && (
                <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                    ...
                    <Grid container alignItems="center" rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                      <Grid item xs={4}>
                        <Checkbox
                          ...
                          checked={applePayActiveStatus}
                          disabled={!applePay}
                          onChange={(e) => handleStatusChange(e, "apple_pay")}
                          sx={{ color: theme.typography.common.blue }}
                        />
                      </Grid>
                      <Grid item xs={4}>
                  ...
                  <Grid item xs={5}>
                    <TextField
                      name="apple_pay"
                      value={applePay?.paymentMethod_name}
                  ...
                  <Grid item xs={6}>
                    <Grid container alignItems="center" rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                      <Grid item xs={4}>
                        <Checkbox
                          name="stripe_status"
                          checked={stripeActiveStatus}
                          disabled={!stripe}
                          onChange={(e) => handleStatusChange(e, "stripe")}
                          sx={{ color: theme.typography.common.blue }}
                        />
                      </Grid>
                      <Grid item xs={4}>
                  ...
                  <Grid item xs={6}>
                    <Grid container alignItems="center" rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                      <Grid item xs={4}>
                        <Checkbox
                          name="zelle_status"
                          checked={zelleActiveStatus}
                          disabled={!zelle}
                          onChange={(e) => handleStatusChange(e, "zelle")}
                          sx={{ color: theme.typography.common.blue }}
                        />
                      </Grid>
                      <Grid item xs={4}>
                  ...
                  <Grid item xs={6}>
                    <Grid container alignItems="center" rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                      <Grid item xs={4}>
                        <Checkbox
                          name="venmo_status"
                          checked={venmoActiveStatus}
                          disabled={!venmo}
                          onChange={(e) => handleStatusChange(e, "venmo")}
                          sx={{ color: theme.typography.common.blue }}
                        />
                      </Grid>
                      <Grid item xs={4}>
              ...
              <Box component="span" m={2} p={2} display="flex" justifyContent="space-between" alignItems="center" className={classes.typography}>
