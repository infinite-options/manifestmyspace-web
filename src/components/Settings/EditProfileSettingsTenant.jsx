...
export default function EditProfileSettingsTenant() {
  ...
  const handleSubmit = (event) => {
    ...
    if (isEdited) {
      ...
      axios
        .put("https://l0h6a9zi1e.execute-api.us-west-1.amazonaws.com/dev/profile", formData, headers)
        .then((response) => {
      ...
      >
        ...
        >
          ...
          >
            ...
            <input id="file-upload" type="file" accept="image/*" hidden onChange={(e) => handleProfileImageUpload(e.target.files[0])} />
            <hr />
            <Box component="form" onSubmit={handleSubmit} noValidate autoComplete="off" id="editProfileForm">
              <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                <Grid item xs={6}>
                  <Stack spacing={-2} m={2}>
                    ...
                    <TextField name="tenant_first_name" value={firstName} onChange={handleInputChange} variant="filled" fullWidth className={classes.root} placeholder="3" />
                  </Stack>
                </Grid>
                <Grid item xs={6}>
                  <Stack>
              ...
              <Stack spacing={-2} m={5}>
                ...
                <TextField
                  ...
                  variant="filled"
                  fullWidth
                  placeholder="1065 Melancholy Lane"
                  className={classes.root}
                ></TextField>
              </Stack>
