        ...
        >
          <div>
            ...
            >
              <img
                ...
                alt="settings"
                onClick={(e) => {
                  navigate("/settingsTenant", { state: { tenant_data: profileData } });
                }}
          ...
          >
            ...
            >
              ...
              >
                <TextBox>{`${profileData?.tenant_first_name} ${profileData?.tenant_last_name}`}</TextBox>
              </Box>
              <Box
                sx={{
                  fontSize: "14px",
              ...
              <GrayBox>
                <FlexBox direction="row">
                  <Box>
                    ...
                    <TextBox fontSize={"12px"}>SSN</TextBox>
                  </Box>
                  <Box>
                    <TextBox fontSize={"16px"} fontWeight={"bold"}>
                      No EIN Provided
                    </TextBox>
                    <TextBox fontSize={"12px"}>EIN</TextBox>
                  </Box>
                </FlexBox>
              </GrayBox>
              <Box
