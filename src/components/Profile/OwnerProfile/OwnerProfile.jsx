        ...
        >
          <Box component="span" display="flex" marginTop="20px" justifyContent="center" alignItems="center" position="relative">
            <img
              ...
              onClick={(e) => {
                navigate("/settingsOwner", { state: { owner_data: profileData, payments_data: payment_accounts } });
              }}
            ></img>
          </Box>
          ...
          >
            ...
            <Stack direction="row" justifyContent="center" marginTop={5}>
              ...
              >
                {profileData.owner_address || profileData.owner_unit || profileData.owner_city || profileData.owner_state || profileData.owner_zip
                  ? [
