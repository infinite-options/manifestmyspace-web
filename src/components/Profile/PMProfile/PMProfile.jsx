  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      >
        ...
        >
          <Box component="span" display="flex" marginTop="20px" justifyContent="center" alignItems="center" position="relative">
            <img
              src={Setting_fill}
              alt="Settings icon"
              style={{ padding: 5, marginTop: 5, position: "absolute", left: 0 }}
              onClick={(e) => {
                navigate("/settingsManager", { state: { manager_data: profileData, payments_data: payment_accounts } });
              }}
            ></img>
          </Box>
          ...
          >
            ...
            {business_service_fees.map((f) => (
              <Stack direction="row" justifyContent="left" marginLeft={10}>
                <Typography
                  sx={{
                    color: theme.typography.common.blue,
                    fontWeight: theme.typography.light.fontWeight,
          ...
          <Paper
            onClick={() => {
              navigate("/PMProfileEdit", { state: { manager_data: profileData } });
            }}
            style={{
              margin: "30px", // Margin around the paper
              marginLeft: "auto",
