import { Typography, Box, Stack, Paper, Button, ThemeProvider, OutlinedInput, InputLabel, MenuItem, FormControl, Select, ListItemText, Checkbox } from "@mui/material";
...
export async function maintenanceOwnerDataCollectAndProcess(setMaintenanceData, setShowSpinner, profileId) {
  ...
  const getMaintenanceData = async () => {
    ...
    setShowSpinner(true);
    const maintenanceRequests = await fetch(`${APIConfig.baseURL.dev}/maintenanceReq/${profileId}`); // Change back to ${getProfileId()}
