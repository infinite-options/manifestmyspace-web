...
export function MaintenanceOwner() {
	...
	const [selectedRequestIndex, setSelectedRequestIndex] = useState(0); // Define these states
	const [selectedStatus, setSelectedStatus] = useState('NEW REQUEST'); // Define these states
