import { ThemeProvider, Typography, Box, Tabs, Tab, Paper, Card, CardHeader, Slider, Stack, Button, Grid, responsiveFontSizes } from "@mui/material";
...
export default function QuotesRequestAction({ maintenanceItem, navigateParams, quotes }) {
  console.log("In QuotesRequestAction");
  console.log("In QuotesRequestAction maintenanceItem: ", maintenanceItem);
  console.log("In QuotesRequestAction navigateParams: ", navigateParams);
  console.log("In QuotesRequestAction quotes: ", quotes);
    ...
    >
      <Grid container direction="row" columnSpacing={6} rowSpacing={6}>
        ...
        >
          ...
          >
            <Typography sx={{ color: "#FFFFFF", fontWeight: theme.typography.primary.fontWeight, fontSize: "14px" }}>Request Additional Quotes</Typography>
        ...
        >
          ...
          >
            <Typography sx={{ color: "#FFFFFF", fontWeight: theme.typography.primary.fontWeight, fontSize: "14px" }}>View Quotes and Accept</Typography>
            <KeyboardArrowRight sx={{ color: "#FFFFFF" }} />
          </Button>
        </Grid>
        <Grid
