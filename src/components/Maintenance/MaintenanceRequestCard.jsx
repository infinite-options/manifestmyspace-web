import { ThemeProvider, Typography, Box, Tabs, Tab, Paper, Card, CardHeader, CardMedia, CardContent, CardActions, IconButton } from "@mui/material";
      ...
      >
        <Card sx={{ maxWidth: 345 }}>
          ...
          {/* <CardHeader
                    ...
                    /> */}
          <CardMedia component="img" height="194" width="300" image={maintenanceRequestImage} alt="Paella dish" />
          <CardContent>
            <Typography sx={{ color: theme.typography.common.blue, fontWeight: theme.typography.common.fontWeight, fontSize: theme.typography.smallFont }}>
              {data.description}
            </Typography>
