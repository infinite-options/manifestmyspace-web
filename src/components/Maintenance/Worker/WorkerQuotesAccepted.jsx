...
import WithdrawQuote from "../../utils/WithdrawQuote";
...
export default function WorkerQuotesAccepted({ maintenanceItem }) {
  ...
  async function handleWithdraw(id) {
    // Change
    let response = WithdrawQuote(id, setShowSpinner);
    console.log("handleWIthdraw", response);
    if (response) {
      console.log("Quote Withdrawn");
      alert("Quote Withdrawn");
      navigate("/workerMaintenance");
    } else {
      console.log("Quote Not Withdrawn");
      alert("Error: Quote Not Withdrawn");
    }
  }
    ...
    >
      ...
      <Grid container direction="row" columnSpacing={6} rowSpacing={6}>
        ...
        >
          ...
          >
            <Typography sx={{ color: "#3D5CAC", fontWeight: theme.typography.primary.fontWeight, fontSize: "13px" }}>{maintenanceItem?.quote_notes}</Typography>
          </Box>
        </Grid>
        <Grid
          item
        ...
        >
          <Button
            ...
            onClick={() => handleWithdraw(maintenanceItem.maintenance_quote_uid)}
          >
            <CloseIcon sx={{ color: "#3D5CAC" }} />
            <Typography sx={{ color: "#3D5CAC", fontWeight: theme.typography.primary.fontWeight, fontSize: theme.typography.smallFont }}>Withdraw Quote</Typography>
          </Button>
        </Grid>
        <Grid
          item
        ...
        >
          ...
          >
            ...
            />
            <Typography sx={{ color: "#3D5CAC", fontWeight: theme.typography.primary.fontWeight, fontSize: theme.typography.smallFont }}>Schedule</Typography>
          </Button>
        </Grid>
        <DateTimePickerModal
          open={showScheduler}
