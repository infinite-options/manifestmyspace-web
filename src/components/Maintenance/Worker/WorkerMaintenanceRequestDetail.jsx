...
export default function WorkerMaintenanceRequestDetail() {
  console.log("In WorkerMaintenanceRequestDetail.jsx WorkerMaintenanceRequestDetailo");
          ...
          >
            ...
            >
              ...
              >
                ...
                {colorStatus[value]?.mapping === "SUBMITTED" ? <WorkerQuotesSubmittedAction maintenanceItem={maintenanceItemsForStatus[maintenanceRequestIndex]} /> : null}
                {colorStatus[value]?.mapping === "ACCEPTED" ? <WorkerQuotesAccepted maintenanceItem={maintenanceItemsForStatus[maintenanceRequestIndex]} /> : null}
                {colorStatus[value]?.mapping === "SCHEDULED" ? <WorkerScheduledMaintenance maintenanceItem={maintenanceItemsForStatus[maintenanceRequestIndex]} /> : null}
                {colorStatus[value]?.mapping === "FINISHED" ? <WorkerFinishedMaintenance maintenanceItem={maintenanceItemsForStatus[maintenanceRequestIndex]} /> : null}
                {colorStatus[value]?.mapping === "PAID" ? <WorkerPaidMaintenance maintenanceItem={maintenanceItemsForStatus[maintenanceRequestIndex]} /> : null}
              </Box>
            </Box>
          </Stack>
        </Paper>
