import { ThemeProvider, Typography, Box, Tabs, Tab, Paper, Card, CardHeader, Slider, Stack, Button, Grid, Checkbox, responsiveFontSizes, Chip } from "@mui/material";
  ...
  return (
    <>
      <Grid container sx={{ paddingTop: "10px" }}>
        ...
        <Grid item xs={3}>
          <Typography sx={{ color: "#3D5CAC", fontWeight: theme.typography.propertyPage.fontWeight, fontSize: "16px" }}># of Hours</Typography>
        </Grid>
        <Grid item xs={3}>
          <Typography sx={{ color: "#3D5CAC", fontWeight: theme.typography.propertyPage.fontWeight, fontSize: "16px" }}>Charge / Hour</Typography>
        </Grid>
        <Grid item xs={3}>
          <Typography sx={{ color: "#3D5CAC", fontWeight: theme.typography.propertyPage.fontWeight, fontSize: "16px" }}>Total</Typography>
        </Grid>
        {labor &&
          labor.map((laborItem, index) => (
            <Grid container key={index}>
              ...
              <Grid item xs={3}>
                <Typography sx={{ color: "#000000", fontWeight: theme.typography.propertyPage.fontWeight, fontSize: "14px" }}>${laborItem.charge || laborItem.rate}</Typography>
              </Grid>
              <Grid item xs={3}>
                <Typography sx={{ color: "#000000", fontWeight: theme.typography.propertyPage.fontWeight, fontSize: "14px" }}>
...
function PartsTableReadOnly({ parts, setParts }) {
  ...
  return (
    <>
      <Grid container sx={{ paddingTop: "10px" }}>
        <Grid item xs={3}>
          <Typography sx={{ color: "#3D5CAC", fontWeight: theme.typography.propertyPage.fontWeight, fontSize: "16px" }}>Parts</Typography>
        </Grid>
        <Grid item xs={3}>
          <Typography sx={{ color: "#3D5CAC", fontWeight: theme.typography.propertyPage.fontWeight, fontSize: "16px" }}>Qty</Typography>
        </Grid>
        <Grid item xs={3}>
          <Typography sx={{ color: "#3D5CAC", fontWeight: theme.typography.propertyPage.fontWeight, fontSize: "16px" }}>Cost</Typography>
        </Grid>
        <Grid item xs={3}>
          <Typography sx={{ color: "#3D5CAC", fontWeight: theme.typography.propertyPage.fontWeight, fontSize: "16px" }}>Total</Typography>
        </Grid>
    ...
    >
      <Grid container direction="column" rowSpacing={2}>
        <Grid container direction="row">
          <Grid item xs={11}>
            <Typography sx={{ color: "#3D5CAC", fontWeight: theme.typography.primary.fontWeight, fontSize: "18px" }}>Maintenance Quote Details</Typography>
            <Chip label={maintenanceItem.quote_status} size="small" style={{ backgroundColor: getChipColor(maintenanceItem.quote_status), color: "white" }} />
          </Grid>
          <Grid item xs={1}>
            <Box sx={{ alignItems: "right", justifyContent: "right" }}>
              {roleName() == "Manager" ? null : (
                <Button onClick={() => navigate("/businessEditQuoteForm", { state: { maintenanceItem: maintenanceItem } })} sx={{ background: "#FFFFFF", color: "#3D5CAC" }}>
                  <EditIcon />
                </Button>
              )}
            </Box>
        ...
        <Grid item xs={12}>
          <Typography sx={{ color: "#3D5CAC", fontWeight: theme.typography.propertyPage.fontWeight, fontSize: "14px" }}>{maintenanceItem?.maintenance_quote_uid}</Typography>
        </Grid>
        <Grid item xs={12}>
          {quoteImages.length > 0 ? (
            <Typography sx={{ color: "#3D5CAC", fontWeight: theme.typography.primary.fontWeight, fontSize: "18px" }}>Maintenance Quote Images</Typography>
          ) : null}
        </Grid>
        <Grid item xs={12}>
          {quoteImages.length > 0
      ...
      <Grid container direction="column" rowSpacing={2}>
        <Grid item xs={12}>
          <Typography sx={{ color: "#3D5CAC", fontWeight: theme.typography.propertyPage.fontWeight, fontSize: "18px" }}>Estimate</Typography>
        </Grid>
      </Grid>
      {JSON.parse(maintenanceItem?.quote_services_expenses)?.event_type === "Fixed Bid" ? (
        <Grid container sx={{ paddingTop: "10px" }}>
          <Grid item xs={6}>
            <Typography sx={{ color: "#3D5CAC", fontWeight: theme.typography.propertyPage.fontWeight, fontSize: "16px" }}>Fixed Bid</Typography>
          </Grid>
          <Grid item xs={6}>
            <Typography sx={{ color: "#3D5CAC", fontWeight: theme.typography.propertyPage.fontWeight, fontSize: "16px" }}>${labor[0]?.rate || 0}</Typography>
          </Grid>
        </Grid>
      ) : labor.length > 0 ? (
        ...
        <Grid container sx={{ paddingTop: "10px" }}>
          <Grid item xs={12}>
            <Typography sx={{ color: "#3D5CAC", fontWeight: theme.typography.propertyPage.fontWeight, fontSize: "16px" }}>No Labor</Typography>
          </Grid>
        </Grid>
      )}
      ...
      {parts.length > 0 ? (
        ...
        <Grid container sx={{ paddingTop: "10px" }}>
          <Grid item xs={12}>
            <Typography sx={{ color: "#3D5CAC", fontWeight: theme.typography.propertyPage.fontWeight, fontSize: "16px" }}>No Parts</Typography>
          </Grid>
        </Grid>
      )}
      ...
      <Grid container direction="column" rowSpacing={2} paddingTop={"20px"}>
        <Grid item xs={12}>
          <Typography sx={{ color: "#000000", fontWeight: theme.typography.medium.fontWeight, fontSize: "18px" }}>Quote Total: ${estimatedCost}</Typography>
        ...
        <Grid item xs={12} sx={{ paddingLeft: "0px" }}>
          <Box display="flex" flexDirection="row" alignItems="center" justifyContent="left">
            <Checkbox checked={true} sx={{ paddingLeft: "0px" }} />
            <Typography
              sx={{
        ...
        <Grid item xs={12} sx={{ paddingLeft: "0px" }}>
          ...
          >
            ...
            <Typography sx={{ color: "#3D5CAC", fontWeight: theme.typography.propertyPage.fontWeight, fontSize: "16px" }}>View Document</Typography>
          </Button>
        </Grid>
        ...
        (roleName == "Maintenance" || roleName === "Maintenance Employee") ? (
          <Grid item xs={12} sx={{ paddingLeft: "0px" }}>
            <Button
              sx={{
      ...
      <DateTimePickerModal setOpenModal={setShowModal} open={showModal} maintenanceItem={maintenanceItem} date={date} time={time} handleSubmit={handleUpdateScheduleDateTime} />
      <AreYouSureModal setOpenModal={setShowWithdrawModal} open={showWithdrawModal} maintenanceItem={maintenanceItem} action={"WITHDRAW"} handleSubmit={handleWithdraw} />
    </Stack>
  );
}
