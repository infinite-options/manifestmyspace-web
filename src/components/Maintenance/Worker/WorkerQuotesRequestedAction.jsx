      ...
      <Grid container direction="row" columnSpacing={6} rowSpacing={6}>
        ...
        >
          ...
          >
            ...
            <Typography sx={{ color: "#3D5CAC", fontWeight: theme.typography.primary.fontWeight, fontSize: theme.typography.smallFont }}>Decline</Typography>
          </Button>
        </Grid>
        <Grid
          item
        ...
        >
          ...
          >
            <Typography sx={{ color: "#3D5CAC", fontWeight: theme.typography.primary.fontWeight, fontSize: theme.typography.smallFont }}>Request more info 1</Typography>
          </Button>
        ...
        >
          ...
          >
            ...
            <Typography sx={{ color: "#3D5CAC", fontWeight: theme.typography.primary.fontWeight, fontSize: theme.typography.smallFont }}>Quote</Typography>
          </Button>
        </Grid>
      </Grid>
    </Box>
