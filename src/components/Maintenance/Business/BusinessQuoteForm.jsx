  ...
  return (
    <>
      <Grid item xs={12} sx={{ paddingTop: "10px" }}>
        <Typography sx={{ color: "#3D5CAC", fontWeight: theme.typography.propertyPage.fontWeight, fontSize: "16px" }}>Cost of Parts</Typography>
      </Grid>
      {parts.map((part, index) => (
        <Grid container key={index} rowSpacing={1} sx={{ paddingTop: "10px" }}>
          <Grid item xs={4} sx={{ paddingTop: "10px" }}>
            <TextField label="Part" size="small" value={part.part} onChange={(e) => handlePartChange(e, index)} />
          </Grid>
          <Grid item xs={3} sx={{ paddingTop: "10px" }}>
            <TextField label="Quantity" size="small" value={part.quantity} onChange={(e) => handleQuantityChange(e, index)} />
          </Grid>
          <Grid item xs={4} sx={{ paddingTop: "10px" }}>
            <TextField
              label="Part Cost"
          ...
          <Grid item xs={1} sx={{ paddingTop: "10px", paddingLeft: "0px" }} alignContent="center" alignItems="center">
            <Button onClick={() => deleteRow(index)} sx={{ padding: "0px", margin: "0px" }}>
      ...
      <Grid item xs={12}>
        ...
        >
          <AddIcon />
          <Typography sx={{ color: "#3D5CAC", fontWeight: theme.typography.propertyPage.fontWeight, fontSize: "14px" }}>Add Row</Typography>
        </Button>
      </Grid>
    </>
  );
...
export default function BusinessQuoteForm({ acceptBool, editBool }) {
  ...
  console.log("In BusinessQuoteForm.jsx ", maintenanceItem);
  ...
  const [availabilityTime, setAvailabilityTime] = useState(
    maintenanceItem?.quote_earliest_availability ? dayjs(maintenanceItem?.quote_earliest_availability.split(" ")[1], "HH:mm").format("h:mm A") : ""
  );
  ...
  async function handleSubmit(status) {
    ...
    const changeQuoteStatus = async (status) => {
      console.log("In changeQuoteStatus", status);
      setShowSpinner(true);
      ...
      try {
        ...
        if (response.status === 200) {
          ...
          //   changeQuoteStatus();  // Not sure if this belongs here or below
        } else {
          ...
          >
            <Grid container direction="column">
              <Grid item xs={12}>
                <Grid container spacing={2} justifyContent="center">
                  <Typography sx={{ color: "#000000", fontWeight: theme.typography.propertyPage.fontWeight, fontSize: "20px" }}>{maintenanceItem.maintenance_title}</Typography>
                </Grid>
              </Grid>
              <ImageCarousel images={displayImages} />
              <Grid item xs={12}>
                <Grid container spacing={2} justifyContent="center" sx={{ paddingTop: "20px" }}>
                  <Typography sx={{ color: "#000000", fontWeight: "10px", fontSize: "14px" }}>{numImages() > 0 ? numImages() + " Images" : "No Images"}</Typography>
                </Grid>
              ...
              <Grid container direction="row">
                <Grid item xs={12}>
                  ...
                  <div style={{ paddingLeft: "10px" }}>
                    <Typography sx={{ color: "#000000", fontWeight: "10px", fontSize: "14px" }}>
                      {maintenanceItem.property_address} {maintenanceItem.property_unit} {maintenanceItem.property_city} {maintenanceItem.property_state}{" "}
                      {maintenanceItem.property_zip}
                    </Typography>
                  </div>
                </Grid>
                <Grid item xs={6}>
                  ...
                  <div style={{ paddingLeft: "10px" }}>
                    <Typography sx={{ color: "#000000", fontWeight: "10px", fontSize: "14px" }}>{maintenanceItem.maintenance_request_created_date}</Typography>
                  </div>
                </Grid>
                <Grid item xs={6}>
                  <Typography sx={{ color: "#000000", fontWeight: theme.typography.propertyPage.fontWeight, fontSize: "16px" }}>
                  ...
                  <div style={{ paddingLeft: "10px" }}>
                    <Typography sx={{ color: "#000000", fontWeight: "10px", fontSize: "14px" }}>{calculateDaysOpen()}</Typography>
                  </div>
                </Grid>
                <Grid item xs={6} sx={{ paddingBottom: "20px" }}>
                  ...
                  <div style={{ paddingLeft: "10px" }}>
                    <Typography sx={{ color: "#000000", fontWeight: "10px", fontSize: "14px" }}>{maintenanceItem.maintenance_desc}</Typography>
                  </div>
                </Grid>
                <Grid item xs={6} sx={{ paddingBottom: "20px" }}>
                  <Typography sx={{ color: "#000000", fontWeight: theme.typography.propertyPage.fontWeight, fontSize: "16px" }}>
                  ...
                  <div style={{ paddingLeft: "10px" }}>
                    <Typography sx={{ color: "#000000", fontWeight: "10px", fontSize: "14px" }}>$ {grandTotal}</Typography>
                  </div>
                </Grid>
              </Grid>
            </Grid>
            <Grid container direction="row" spacing={1}>
              {acceptBool ? (
                <>
                  <Grid item xs={12} sx={{ paddingTop: "10px" }}>
                    <Typography sx={{ color: "#3D5CAC", fontWeight: theme.typography.propertyPage.fontWeight, fontSize: "16px" }}>Labor Details</Typography>
                  </Grid>
                  <Grid item xs={12} sx={{ paddingTop: "10px" }}>
                    <Typography sx={{ color: "#3D5CAC", fontWeight: theme.typography.propertyPage.fontWeight, fontSize: "12px" }}>Job Type</Typography>
                    <Select
                      sx={{ backgroundColor: "white", borderColor: "black", borderRadius: "7px" }}
                      size="small"
                      fullWidth
                  ...
                  {jobType === "Hourly" ? (
                    <>
                      <Grid item xs={4} sx={{ paddingTop: "10px" }}>
                        <Typography sx={{ color: "#3D5CAC", fontWeight: theme.typography.propertyPage.fontWeight, fontSize: "12px" }}># of hours</Typography>
                        <TextField
                          size="small"
                          sx={{
                      ...
                      <Grid item xs={4} sx={{ paddingTop: "10px" }}>
                        <Typography sx={{ color: "#3D5CAC", fontWeight: theme.typography.propertyPage.fontWeight, fontSize: "12px" }}>Charge/Hour</Typography>
                        <TextField size="small" fullWidth value={rate} onChange={handleRateChange} />
                      </Grid>
                      <Grid item xs={4} sx={{ paddingTop: "10px" }}>
                        <Typography sx={{ color: "#3D5CAC", fontWeight: theme.typography.propertyPage.fontWeight, fontSize: "12px" }}>Total Cost</Typography>
                        <TextField
                          size="small"
                          fullWidth
                          readOnly
                    ...
                    <Grid item xs={4} sx={{ paddingTop: "10px" }}>
                      <Typography sx={{ color: "#3D5CAC", fontWeight: theme.typography.propertyPage.fontWeight, fontSize: "12px" }}>Charge</Typography>
                      <TextField
                        size="small"
                        fullWidth
                        value={rate}
                  ...
                  <Grid item xs={12}>
                    <Typography sx={{ color: "#3D5CAC", fontWeight: theme.typography.propertyPage.fontWeight, fontSize: "16px" }}>Earliest Availability</Typography>
                  </Grid>
                  ...
                  <Grid item xs={12} sx={{ paddingTop: "10px" }}>
                    <Typography sx={{ color: "#3D5CAC", fontWeight: theme.typography.propertyPage.fontWeight, fontSize: "16px" }}>Notes</Typography>
                    <TextField
                      multiline
                      required
                      rows={2}
                ...
                <>
                  <Grid item xs={12} sx={{ paddingTop: "10px" }}>
                    <Typography sx={{ color: "#000000", fontWeight: theme.typography.propertyPage.fontWeight, fontSize: "16px" }}>Notes</Typography>
                    <TextField
                      multiline
                      required
                      rows={5}
