        ...
        <div className="mt-prop-widget-container">
          ...
          <div className="mt-prop-widget-graph">
            <PieChart width={200} height={250}>
              <Legend height={36} iconType="circle" layout="vertical" verticalAlign="bottom" iconSize={5} padding={5} formatter={renderColorfulLegendText} />
              <Pie data={data} cx={80} cy={100} innerRadius={35} outerRadius={50} paddingAngle={0} dataKey="number">
