    ...
    <div>
      <Modal open={props.open} onClose={handleClose} aria-labelledby='modal-modal-title' aria-describedby='modal-modal-description'>
        <Box sx={style}>
          ...
          <FormControlLabel control={<Checkbox checked={isCheck} onChange={(e) => setIsCheck(e.target.checked)} />} label='Received by Check' />
          ...
          <Grid container rowSpacing={6} padding={4}>
            <Grid item xs={6} sx={{ padding: "8px" }}>
              <Button variant='contained' sx={{ backgroundColor: "#FFFFFF", color: "#FFFFFF" }} onClick={() => handleClose()}>
                ...
                <Typography sx={{ color: "#3D5CAC", fontWeight: theme.typography.primary.fontWeight, fontSize: theme.typography.mediumFont }}>Cancel</Typography>
              </Button>
            </Grid>
            <Grid item xs={6} sx={{ padding: "8px" }}>
              <Button variant='contained' color='primary' sx={{ backgroundColor: "#3D5CAC", color: "#000000" }} onClick={() => submit(checkNumber, amount)}>
                ...
                <Typography sx={{ color: "#FFFFFF", fontWeight: theme.typography.primary.fontWeight, fontSize: theme.typography.mediumFont }}>Confirm</Typography>
              </Button>
            </Grid>
          </Grid>
        </Box>
