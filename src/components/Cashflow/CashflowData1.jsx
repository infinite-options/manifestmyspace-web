...
const CashflowData = (props) => {
    ...
    const fetchCashflow = async () => {
        ...
        const cashflow = await axios.get(
            'https://l0h6a9zi1e.execute-api.us-west-1.amazonaws.com/dev/cashflowByOwner/110-000003/TTM'
        );
