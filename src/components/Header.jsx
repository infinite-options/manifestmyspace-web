        ...
        {isLoggedIn ? (
            ...
            <Box>
                ...
                {isMenuOpen && (
                    ...
                    {/* Menu Items */}
                    <Button sx={{ display: 'block', width: '100%' }} onClick={() => navigate("/returningUser")}>Login</Button>
                    <Button sx={{ display: 'block', width: '100%' }} onClick={() => navigate("/newUser")}>Create Account</Button>
                    </Box>
                )}
            </Box>
        )}
