                ...
                return (
                    <AccordionDetails>
                        <Box
                            ...
                            onClick={() => { navigateTo(rentDetailUrl, index) }}
                        >
                            <Box sx={{
