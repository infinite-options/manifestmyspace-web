            ...
            <Box sx={{overflow: 'hidden', display: "flex", width: "auto", alignItems: "center", justifyContent: "center", flexGrow: 1 }}>
                ...
                <Card sx={{ minWidth: 300, padding: 2, margin: 2, opacity: "50%" }}>
                    ...
                    <Typography sx={{color: "#000000", fontSize: "16px", fontWeight: 500, opacity: "50%"}}>
                        {announcementList[prevCardIndex].announcement_msg}
                    </Typography>
                    <Typography sx={{color: "#000000", fontSize: "16px", fontWeight: 500, opacity: "50%"}}>
                        {announcementList[prevCardIndex].announcement_uid}
                    </Typography>
                </Card>
                )}
                ...
                <Card sx={{ minWidth: 300, padding: 2, margin: 2, opacity: "50%" }}>
                    ...
                    <Typography sx={{color: "#000000", fontSize: "16px", fontWeight: 500, opacity: "50%"}}>
                        {announcementList[nextCardIndex].announcement_msg}
                    </Typography>
                    <Typography sx={{color: "#000000", fontSize: "16px", fontWeight: 500, opacity: "50%"}}>
                        {announcementList[nextCardIndex].announcement_uid}
                    </Typography>
                </Card>
                )}
            </Box>
