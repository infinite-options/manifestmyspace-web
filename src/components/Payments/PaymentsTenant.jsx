...
import { Box, ThemeProvider, Paper, Button, Typography, Stack, Grid, TextField, IconButton, Checkbox } from "@mui/material";
...
export default function PaymentsTenant(props) {
  console.log("In PaymentsTenant.jsx");
  ...
  const handleCheckboxChange = (index) => {
    setSelectedItems((prevSelectedItems) => {
      ...
      console.log("Current Selection: ", newSelectedItems);
      ...
      <ThemeProvider theme={theme}>
        ...
        >
          ...
          >
            ...
            <Stack direction="row" justifyContent="left" m={4}>
              <Typography sx={{ color: theme.typography.common.blue, fontSize: theme.typography.smallFont }}>Due date: Aug 1st 2023</Typography>
            </Stack>
            <Stack direction="row" justifyContent="center" m={2}>
              <TextField
                variant="filled"
            ...
            <Stack direction="row" justifyContent="left" m={2}>
              <Typography sx={{ color: theme.typography.common.blue, fontWeight: theme.typography.medium.fontWeight, fontSize: "17px" }}>+ Add Account</Typography>
            </Stack>
          </Paper>
                ...
                {paymentDueResult.map((item, index) => (
                  <Grid item xs={12} key={index}>
                    <Grid container alignItems="center">
                      <Grid item xs={6} container alignItems="center">
                        <Checkbox checked={selectedItems[index]} onChange={() => handleCheckboxChange(index)} style={selectedCheckboxStyle} />
                        <Typography
                          sx={{
                            color: theme.typography.primary.black,
                            fontWeight: theme.typography.medium.fontWeight,
