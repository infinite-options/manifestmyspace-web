                ...
                <Box sx={{
                    ...
                    <Box sx={{
                        ...
                        <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M11.2157 13.9997C10.6057 13.9997 9.74881 13.7791 8.46568 13.0622C6.90537 12.1872 5.69849 11.3794 4.14662 9.83158C2.65037 8.33627 1.92224 7.36815 0.903181 5.51377C-0.248069 3.42002 -0.0518188 2.32252 0.167556 1.85346C0.428806 1.29283 0.814431 0.957523 1.31287 0.62471C1.59598 0.439221 1.89558 0.280216 2.20787 0.14971C2.23912 0.136273 2.26818 0.12346 2.29412 0.111898C2.44881 0.0422101 2.68318 -0.0631024 2.98006 0.0493976C3.17818 0.123773 3.35506 0.27596 3.63193 0.549398C4.19974 1.1094 4.97568 2.35659 5.26193 2.96908C5.45412 3.3819 5.58131 3.6544 5.58162 3.96002C5.58162 4.31783 5.40162 4.59377 5.18318 4.89158C5.14224 4.94752 5.10162 5.00096 5.06224 5.05283C4.82443 5.36533 4.77224 5.45565 4.80662 5.6169C4.87631 5.94096 5.39599 6.90565 6.25006 7.75784C7.10412 8.61002 8.04099 9.0969 8.36631 9.16627C8.53443 9.20221 8.62662 9.14783 8.94912 8.90158C8.99537 8.86627 9.04287 8.82971 9.09256 8.79315C9.42568 8.54534 9.68881 8.37002 10.0382 8.37002H10.0401C10.3441 8.37002 10.6044 8.5019 11.0357 8.7194C11.5982 9.00315 12.8829 9.76908 13.4463 10.3375C13.7204 10.6138 13.8732 10.79 13.9479 10.9878C14.0604 11.2856 13.9544 11.5191 13.8854 11.6753C13.8738 11.7013 13.861 11.7297 13.8476 11.7613C13.716 12.073 13.5561 12.372 13.3697 12.6544C13.0376 13.1513 12.701 13.536 12.1391 13.7975C11.8506 13.934 11.5348 14.0031 11.2157 13.9997Z" fill="#F2F2F2" />
                        </svg>
                    </Box>
                    <Box sx={{
                        paddingRight: '5px',
...
function TableRow(props) {
    ...
    return (
        <tr>
            <td style={tdStyle}>
                <img src={image} alt="Maintenace" style={{ width: '45px', height: '35px' }} />
            </td>
            <td style={tdStyle}>
                {title}
            </td>
