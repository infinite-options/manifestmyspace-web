...
export default function OwnerDashboard() {
  console.log("Info in useUser: ", useUser());
  const { user, getProfileId } = useUser(); // Not seeing what is in getProfileId
  console.log("Profile ID: ", getProfileId);
  const navigate = useNavigate();
  console.log("Navigate Info: ", navigate); // Not seeing what is in navigate
  let date = new Date();
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      console.log("Profile ID in UseEffect: ", getProfileId); // Not seeing what is in getProfileId
      ...
      // CASHFLOW Status  (PM - should this be in its own div below?)
      setCashflowStatus(jsonData.CashflowStatus.result);

      // MAINTENANCE Status  (PM - why have Data after MaintenanceStatus?)
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      <div className="mt-widget-main">
        <CashflowWidget cashflowData={cashflowStatus} />
